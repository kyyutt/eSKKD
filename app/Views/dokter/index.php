...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
    <div>
        <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Data Master Dokter</h2>
        <p class="text-xs text-slate-500 font-medium">Database dokter terpusat Puskesmas Elly Uyo</p>
    </div>
    <button onclick="toggleModal('modalDokter')"
...
<div class="bg-white p-4 mt-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col md:flex-row gap-4 items-center">
    ...
    <div class="relative flex-1 w-full text-nowrap">
        <input id="searchDokter" type="text"
            placeholder="Cari Nomor Identitas atau Nama Dokter..."
        ...
        <table class="w-full text-left border-collapse">
            <thead class="bg-emerald-900 text-white/90">
                <tr>
                    ...
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Nomor Identitas</th>
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Nama Dokter</th>
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-right rounded-tr-2xl">Aksi</th>
                </tr>
            </thead>

            <tbody id="tbodyDokter" class="divide-y divide-slate-100 bg-white"></tbody>
        </table>
    </div>
