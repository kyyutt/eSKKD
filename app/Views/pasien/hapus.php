<div id="modalHapusPasien" class="fixed inset-0 z-[100] hidden items-center justify-center bg-emerald-950/60 backdrop-blur-sm p-4">
    <div class="bg-white w-full max-w-sm rounded-[2.5rem] shadow-2xl overflow-hidden p-8 text-center border border-slate-200">
        ...
        <div class="mt-8 space-y-3">
            ...
            <button onclick="toggleModal('modalHapusPasien')"
