...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
    <div>
        <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Data Master Pasien</h2>
        <p class="text-xs text-slate-500 font-medium">Database pasien terpusat Puskesmas Elly Uyo</p>
    </div>
    <button onclick="toggleModal('modalPasien')"
        ...
        <table class="w-full text-left border-collapse">
            <thead class="bg-emerald-900 text-white/90">
                <tr>
                    ...
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">NIK Pasien</th>
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Nama Lengkap</th>
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Tempat/Tgl Lahir</th>
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-center">L/P</th>
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Pekerjaan</th>
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-right rounded-tr-2xl">Aksi</th>
                </tr>
            </thead>

            <tbody id="tbodyPasien" class="divide-y divide-slate-100 bg-white"></tbody>
        </table>
    </div>
...
<?= $this->section('modals') ?>
    <?php echo view('pasien/tambah'); ?>
    <?php echo view('pasien/edit'); ?>
    <?php echo view('pasien/detail'); ?>
    <?php echo view('pasien/hapus'); ?>
<?= $this->endSection() ?>