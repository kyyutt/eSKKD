...
<?php
if (session()->get('role') === 'Petugas Loket') {
?>
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            <h2 class="text-2xl font-bold text-slate-800 tracking-tight">Riwayat Pendaftaran SKKD</h2>
            <p class="text-xs text-slate-500 font-medium">Data riwayat pemeriksaan dan pengajuan surat kesehatan</p>
        </div>
...
<div class="bg-white p-4 mt-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col md:flex-row gap-4 items-center">
    ...
    <div class="relative flex-1 w-full text-nowrap">
        <input id="searchPendaftaran" type="text"
            placeholder="Cari data pendaftaran SKKD (Nama Pasien, NIK, Dokter)..."
        ...
        <table class="w-full text-left border-collapse">
            <thead class="bg-emerald-900 text-white/90">
                <tr>
                    ...
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Data Pasien</th>
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Dokter Pemeriksa</th>
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Tgl Periksa</th>
                    <th class="px-6 py-4 text-xs font-semibold uppercase tracking-wider">Keperluan</th>
            ...
            <tbody id="tbodyPendaftaran" class="divide-y divide-slate-100 bg-white">
            </tbody>
        </table>
    </div>
...
<script src="<?= base_url('assets/js/riwayat_pendaftaran.js') ?>"></script>
<script>
...
<?= $this->section('modals') ?>
<?php echo view('riwayat_pendaftaran/edit'); ?>
<?php echo view('riwayat_pendaftaran/detail'); ?>
<?php echo view('riwayat_pendaftaran/hapus'); ?>
<?php echo view('riwayat_pendaftaran/verifikasi'); ?>
<?= $this->endSection() ?>